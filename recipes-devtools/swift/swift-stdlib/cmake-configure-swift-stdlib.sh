...
LIBS="-latomic" cmake -S ${SWIFT_SRCDIR} -B ${SWIFT_BUILDDIR} -G Ninja \
    ...
    -DICU_I18N_INCLUDE_DIRS=${STAGING_DIR_TARGET}/usr/include \
    -DICU_UC_LIBRARIES=${STAGING_DIR_TARGET}/usr/lib/libicuuc.so \
    -DICU_UC_INCLUDE_DIRS=${STAGING_DIR_TARGET}/usr/include \
    ...
    -DSWIFT_SYNTAX_SOURCE_DIR=${SWIFT_SYNTAX_SOURCE_DIR} \
