...
\nset(CMAKE_C_COMPILER ${STAGING_DIR_NATIVE}/usr/bin/clang) \
\nset(CMAKE_CXX_COMPILER ${STAGING_DIR_NATIVE}/usr/bin/clang++) \
...
\nset(SWIFT_NATIVE_CLANG_TOOLS_PATH ${STAGING_DIR_NATIVE}/usr/bin) \
\nset(SWIFT_NATIVE_LLVM_TOOLS_PATH ${STAGING_DIR_NATIVE}/usr/bin) \
\nset(SWIFT_NATIVE_SWIFT_TOOLS_PATH ${STAGING_DIR_NATIVE}/usr/bin) \
